...
fn BrotliParseAsUTF8(mut symbol: &mut [i32], mut input: &[u8], mut size: usize) -> usize {
  ...
  if size > 1u32 as (usize) && (input[(0usize)] as (i32) & 0xe0i32 == 0xc0i32) &&
  ...
  if size > 2u32 as (usize) && (input[(0usize)] as (i32) & 0xf0i32 == 0xe0i32) &&
     (input[(1usize)] as (i32) & 0xc0i32 == 0x80i32) &&
  ...
  if size > 3u32 as (usize) && (input[(0usize)] as (i32) & 0xf8i32 == 0xf0i32) &&
     (input[(1usize)] as (i32) & 0xc0i32 == 0x80i32) &&
     (input[(2usize)] as (i32) & 0xc0i32 == 0x80i32) &&
     (input[(3usize)] as (i32) & 0xc0i32 == 0x80i32) {
    *symbol =
      (input[(0usize)] as (i32) & 0x7i32) << 18i32 | (input[(1usize)] as (i32) & 0x3fi32) << 12i32 |
      (input[(2usize)] as (i32) & 0x3fi32) << 6i32 | input[(3usize)] as (i32) & 0x3fi32;
