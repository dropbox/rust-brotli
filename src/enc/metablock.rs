...
>(
    ...
    if xself.num_blocks_ == 0usize {
        ...
        split.num_types = split.num_types.wrapping_add(1_usize);
        xself.curr_histogram_ix_ = xself.curr_histogram_ix_.wrapping_add(1_usize);
            ...
            && (diff[1usize] > xself.split_threshold_)
        {
            ...
            HistogramClear(&mut histograms[xself.curr_histogram_ix_]);
            if {
                xself.merge_last_count_ = xself.merge_last_count_.wrapping_add(1_usize);
