...
#[allow(unused)]
static kOmitLastNTransforms: [u8; 10] = [
  0i32 as (u8),
  12i32 as (u8),
  27i32 as (u8),
  23i32 as (u8),
...
macro_rules! sub_match8 {
  ($s1 : expr, $s2 : expr, $limit : expr, $matched : expr, $s1_as_64 : expr, $s2_as_64 : expr) => {
    ...
    if $s2_as_64 == $s1_as_64 {
      ...
      $matched = $matched.wrapping_add((($s2_as_64 ^ $s1_as_64).trailing_zeros() >> 3i32) as usize)
        as u32 as usize;
      return $matched;
    }
  };
  ...
  let mut has_found_match: i32 = 0i32;
  {
    ...
    while end == 0 {
      ...
      if w.transform() as (i32) == 0i32 {
          ...
          if s[(1usize)] as (i32) == b'a' as (i32) {
            ...
            if s[(2usize)] as (i32) == b'h' as (i32) {
              if s[(3usize)] as (i32) == b'e' as (i32) {
                ...
                if s[(4usize)] as (i32) == b't' as (i32) && (s[(5usize)] as (i32) == b' ' as (i32))
                {
                  //eprint!("Sdding match {} {} {} {}\n", w.len(), w.transform(), w.idx(), len);
                  AddMatch(
          ...
          if s[(1usize)] as (i32) == b' ' as (i32) {
            ...
            if s[(2usize)] as (i32) == b'T' as (i32) && (s[(3usize)] as (i32) == b'h' as (i32)) {
              if s[(4usize)] as (i32) == b'e' as (i32) {
                ...
                if s[(5usize)] as (i32) == b's' as (i32) && (s[(6usize)] as (i32) == b' ' as (i32))
                {
        ...
        AddMatch(
          id.wrapping_add((if is_all_caps != 0 { 44i32 } else { 9i32 } as (usize)).wrapping_mul(n)),
          l,
          l,
          matches,
        );
        ...
        if s[(0usize)] as (i32) == b' ' as (i32) {
          ...
          if s[(1usize)] as (i32) == b'>' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 97i32 } else { 69i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(2usize),
              l,
              matches,
          ...
          AddMatch(
            id.wrapping_add(
              (if is_all_caps != 0 { 101i32 } else { 79i32 } as (usize)).wrapping_mul(n),
            ),
            l.wrapping_add(1usize),
            l,
            matches,
          ...
          if s[(1usize)] as (i32) == b' ' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 114i32 } else { 88i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(2usize),
              l,
              matches,
          ...
          AddMatch(
            id.wrapping_add(
              (if is_all_caps != 0 { 112i32 } else { 99i32 } as (usize)).wrapping_mul(n),
            ),
            l.wrapping_add(1usize),
            l,
            matches,
          ...
          if s[(1usize)] as (i32) == b' ' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 107i32 } else { 58i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(2usize),
              l,
              matches,
          ...
          AddMatch(
            id.wrapping_add(
              (if is_all_caps != 0 { 113i32 } else { 78i32 } as (usize)).wrapping_mul(n),
            ),
            l.wrapping_add(1usize),
            l,
            matches,
          ...
          if s[(1usize)] as (i32) == b'\"' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 105i32 } else { 104i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(2usize),
              l,
              matches,
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 116i32 } else { 108i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(2usize),
              l,
              matches,
    ...
    && (data[(0usize)] as (i32) == b' ' as (i32) || data[(0usize)] as (i32) == b'.' as (i32))
  {
    ...
    while end == 0 {
      ...
      if w.transform() as (i32) == 0i32 {
        ...
        AddMatch(
          id.wrapping_add((if is_space != 0 { 6i32 } else { 32i32 } as (usize)).wrapping_mul(n)),
          l.wrapping_add(1usize),
          l,
          matches,
        );
        ...
        if s[(0usize)] as (i32) == b' ' as (i32) {
          ...
          AddMatch(
            id.wrapping_add((if is_space != 0 { 2i32 } else { 77i32 } as (usize)).wrapping_mul(n)),
            l.wrapping_add(2usize),
            l,
            matches,
          );
          ...
          AddMatch(
            id.wrapping_add((if is_space != 0 { 89i32 } else { 67i32 } as (usize)).wrapping_mul(n)),
            l.wrapping_add(2usize),
            l,
            matches,
          );
        ...
        if s[(0usize)] as (i32) == b' ' as (i32) {
          ...
          if s[(1usize)] as (i32) == b' ' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 111i32 } else { 65i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(3usize),
              l,
              matches,
          ...
          AddMatch(
            id.wrapping_add(
              (if is_all_caps != 0 { 115i32 } else { 96i32 } as (usize)).wrapping_mul(n),
            ),
            l.wrapping_add(2usize),
            l,
            matches,
          ...
          if s[(1usize)] as (i32) == b' ' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 117i32 } else { 91i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(3usize),
              l,
              matches,
          ...
          if s[(1usize)] as (i32) == b'\"' as (i32) {
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 110i32 } else { 118i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(3usize),
              l,
              matches,
            ...
            AddMatch(
              id.wrapping_add(
                (if is_all_caps != 0 { 119i32 } else { 120i32 } as (usize)).wrapping_mul(n),
              ),
              l.wrapping_add(3usize),
              l,
              matches,
