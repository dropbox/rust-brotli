...
pub unsafe extern "C" fn BrotliEncoderCreateInstance(
  ...
  match catch_panic_cstate(|| {
    ...
    let to_box = BrotliEncoderState {
      ...
      compressor: ::enc::encode::BrotliEncoderCreateInstance(BrotliSubclassableAllocator::new(
...
pub unsafe extern "C" fn BrotliEncoderCompress(
  ...
  match catch_panic(|| {
    ...
    let mut m8 = BrotliSubclassableAllocator::new(SubclassableAllocator::new(allocators.clone()));
    let empty_m8 = BrotliSubclassableAllocator::new(SubclassableAllocator::new(allocators.clone()));
